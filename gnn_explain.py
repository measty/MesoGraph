...
def make_chart(feat_imp,used_feats,txt,type='box'):
    if type=='bar':
        ...
        p = figure(y_range=top_feats, height=500, width=400, title=f"Top feats: {txt}",
        ...
        # boxes
        p.hbar(top_feats, 0.7, qs[1,:], qs[2,:], fill_color="#E08E79", line_color="black")
        p.hbar(top_feats, 0.7, qs[0,:], qs[1,:], fill_color="#3B8686", line_color="black")
